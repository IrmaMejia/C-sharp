...
public class MatrizdeDatos
{
    ...
    {
      Huesped huesped1 = new Huesped(001,"Aracely Mejia",1);
      ListadeHuesped.Add(huesped1);
      Huesped huesped2 = new Huesped(002,"Romario Enamorado",2);
      ListadeHuesped.Add(huesped2);
      Huesped huesped3 = new Huesped(003,"Antonio Odz",3);
      ListadeHuesped.Add(huesped3);
      Huesped huesped4 = new Huesped(004,"Heber Alvarado",4);
    ...
    public void reservar(int numero,string reservas,string clientes)
    {
      foreach (var habitaciones in Listadecuartos)
        {
